...
// Import validateFilePath from main.js
// Note: main.js uses CommonJS, so we need to use dynamic import
let validateFilePath;

beforeAll(async () => {
  const mainModule = await import('../../main.js');
  validateFilePath = mainModule.validateFilePath;
});
...
describe('Path Traversal Security Tests', () => {
  ...
  describe('Path Traversal Attacks', () => {
    ...
    it('should reject path with .. pattern in normalized path', () => {
